<?php
	...
	if($uploadOk == 0){
		...
		if(move_uploaded_file($_FILES["fileupload"]["tmp_name"], $fileupload)&&move_uploaded_file($_FILES["fileupload2"]["tmp_name"], $fileupload2)){
			...
			if ($conn->query($sql) === TRUE) {
				...
				header("Location:forminputbuku.php");
			}
		} else {
