  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Manage Peminjaman</a></li>
        <li class="active">History Peminjaman</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
				...
				<?php
					include "koneksi.php";
					$sql = "select * from peminjaman join user on (peminjaman.username=user.username)";
					...
					if ($result->num_rows > 0) {
						...
						while($row = $result->fetch_assoc()) {
							echo "<tr>
                                      ...
                                      <td>" . $row["denda"]. "</td>
									  <td>" . $row["status"]. "</td>
									  <td> <a href='pengembalianbuku.php?id=".$row["kodepinjam"]."' class='fa fa-book' title='Pengembalian Buku'></a> </td>
								  </tr>";
						}
					} else {
